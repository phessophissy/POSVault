...
(define-public (claim-rewards)
  (let (
    ...
    (print { event: "claim-rewards", depositor: claimer, rewards: pending-rewards })
    (ok pending-rewards)
  )
)
