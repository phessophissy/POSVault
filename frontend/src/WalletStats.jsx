...
export default function WalletStats() {
  ...
  return (
    <div className="walletstats-container">
      <h2>WalletStats</h2>
...
/** CSS-in-JS styles */
export const walletstatsStyles = {
  container: {
    padding: "24px",
    maxWidth: "1200px",
    margin: "0 auto",
...
/** WalletStats utility constants */
export const WALLETSTATS_CONSTANTS = {
  MIN_DEPOSIT: 1000,
  MAX_DISPLAY_ROWS: 50,
