...
export default function RewardChart() {
  ...
  return (
    <div className="rewardchart-container">
      <h2>RewardChart</h2>
...
/** CSS-in-JS styles */
export const rewardchartStyles = {
  container: {
    padding: "24px",
    maxWidth: "1200px",
    margin: "0 auto",
...
/** RewardChart utility constants */
export const REWARDCHART_CONSTANTS = {
  MIN_DEPOSIT: 1000,
  MAX_DISPLAY_ROWS: 50,
