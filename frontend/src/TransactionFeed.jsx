...
/** CSS-in-JS styles */
export const transactionfeedStyles = {
  container: {
    padding: "24px",
    maxWidth: "1200px",
    margin: "0 auto",
...
/** TransactionFeed prop types documentation */
/**
 * @typedef {TransactionFeedProps}
...
/** Default props */
export const defaultTransactionFeedProps = {
  network: "mainnet",
  autoRefresh: true,
  refreshInterval: 30000,
  onError: (err) => console.error(`TransactionFeed error:`, err),
};

/** TransactionFeed utility constants */
export const TRANSACTIONFEED_CONSTANTS = {
  MIN_DEPOSIT: 1000,
  MAX_DISPLAY_ROWS: 50,
