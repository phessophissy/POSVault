...
/** ProposalList prop types documentation */
/**
 * @typedef {ProposalListProps}
...
/** Default props */
export const defaultProposalListProps = {
  network: "mainnet",
  autoRefresh: true,
  refreshInterval: 30000,
  onError: (err) => console.error(`ProposalList error:`, err),
};

/** ProposalList utility constants */
export const PROPOSALLIST_CONSTANTS = {
  MIN_DEPOSIT: 1000,
  MAX_DISPLAY_ROWS: 50,
