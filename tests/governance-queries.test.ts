...
describe("Governance Queries - time utilities", () => {
...
describe("Governance Queries - batch operations", () => {
...
describe("Governance Queries - config management", () => {
...
describe("Governance Queries - integration summary", () => {
