...
/** Format RateLimiter entry for display */
export function formatRateLimiterEntry(
...
/** Serialize RateLimiter entries to JSON */
export function serializeRateLimiterEntries(
  entries: RateLimiterEntry[]
): string {
